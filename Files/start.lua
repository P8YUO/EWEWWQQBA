...
local Get_Files  = io.popen("curl -s https://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@raw.githubusercontent.com/P8YUO/fil/main/getfile.json"):read('*a')
...
datar[#json.plugins_ +1] = {{text = "‹ مطور السورس ›",url ="https://t.me/P17_12"}}
end
return datar
end
...
rel = io.popen("curl -s https://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@raw.githubusercontent.com/P8YUO/fil/main/getfile.json"):read('*a')
...
local GetJson = io.popen('curl -s https://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@raw.githubusercontent.com/33yyllcc/TEPTHONPRIVEFILE/main/Files/'..FileName):read('*a')
...
type = 'inline',
data = {
{{text = '℘ ᴛᴇᴘᴛʜᴏɴ sᴏᴜʀᴄᴇ .',url="t.me/Tepthon"}},
}
}
...
{{text = '℘ قناه التحديثات .',url="t.me/Tepthon"}},
{{text = '℘ رجوع .',data="Can"}},
}
}
...
{{text = '℘ :   𝑇𝐸𝑃𝑇𝐻𝑂𝑁 𝑆𝑂𝐔𝑅𝐶𝐸 .',url="t.me/Tepthon"}},
...
namet = {"حجي اسمي "..(redis:get(bot_id..":namebot") or "تيبثون"),"يابه اسمي "..(redis:get(bot_id..":namebot") or "تيبثون"),"اني لقميل "..(redis:get(bot_id..":namebot") or "تيبثون"),(redis:get(bot_id..":namebot") or "تيبثون").." اني"}
...
reply_to_message_id=msg.id,
reply_markup=markup(nil,{{{text = '℘ ᴛᴇᴘᴛʜᴏɴ sᴏᴜʀᴄᴇ .',url="t.me/Tepthon"}}})
})
end
end
if not redis:get(bot_id..":"..msg.chat_id..":settings:singforme") then
...
local Text = "*℘ :  WeLCoMe To  Tepthon Source  .*\n"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '℘ : 𝐒𝐎𝐔𝐑𝐂𝐄 𝐓𝐄𝐏𝐓𝐇𝐎𝐍   .',url="https://t.me/Tepthon"}},
{{text = '℘ :  inFo  𝐓𝐄𝐏𝐓𝐇𝐎𝐍 .',url="https://t.me/P17_12"}},
{{text = '℘ :  CoDeR .',url="https://t.me/P17_12"},{text = '℘ :  TwS .',url="https://t.me/P17_12"}},
}
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/Tepthon/9&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
----------------------------------------------------------------------------------------------------
if text == 'تفعيل' then
if msg.can_be_deleted_for_all_users == false then
